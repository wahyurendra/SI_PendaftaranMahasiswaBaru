	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <a class="navbar-brand" href="<?=base_url();?>"><span>PMB </span>STSN.</a>
          ...
          <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="<?=base_url();?>home/prodi" class="nav-link">Prodi</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
            <h1 class="mb-3 bread"><span>Program</span></h1><h2 class="mb-3 bread"> Studi</h2>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style="background-image: url('<?php echo base_url();?>assets/landing/images/image_1.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4">
              		<div class="one">
              			<span class="day">RPLK</span>
              		</div>
              	</div>
                <h3 class="heading mt-2"><a href="#">REKAYASA PERANGKAT LUNAK KRIPTO</a></h3>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="blog-single.html" class="block-20" style="background-image: url('<?php echo base_url();?>assets/landing/images/image_2.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4">
              		<div class="one">
              			<span class="day">RKS</span>
              		</div>
              	</div>
                <h3 class="heading mt-2"><a href="#">REKAYASA KEAMANAN SIBER</a></h3>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('<?php echo base_url();?>assets/landing/images/image_3.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4">
              		<div class="one">
              			<span class="day">RPKK</span>
              		</div>
              	</div>
                <h3 class="heading mt-2"><a href="#">REKAYASA PERANGKAT KERAS KRIPTO</a></h3>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="blog-single.html" class="block-20" style="background-image: url('<?php echo base_url();?>assets/landing/images/image_4.jpg');">
              </a>
              <div class="text p-4 float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4">
              		<div class="one">
              			<span class="day">RSK</span>
              		</div>
              	</div>
                <h3 class="heading mt-2"><a href="#">REKAYASA SISTEM KRIPTOGRAFI</a></h3>
              </div>
            </div>
          </div>
