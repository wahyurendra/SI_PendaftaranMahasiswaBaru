 <!-- Main Header -->
  <header class="main-header">
    ...
    <a href="<?php echo base_url('home') ?>" class="logo">
      ...
      <span class="logo-lg"><b>STSN</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo base_url('assets/logo.png') ?>" width="160px" height="160px" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo base_url('assets/logo.png') ?>" width="160px" height="160px" class="img-circle" alt="User Image">
